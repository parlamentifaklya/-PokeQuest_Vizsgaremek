...
const cardDescriptions: Record<string, string> = {
  ...
  "Summon": "There are 2 types of chest, the Summon is for Feylings: 100 gems to open it, it is a critical point in the game because your starter Feylings are weaker than them. Also if you open a duplicate you will earn a lot of gems.",
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.cardHolder}>
        ...
        <Button route='/gamemenu' text='Back'/>
      </div>
