...
{
    /// <inheritdoc />
    public partial class sqlitelocal_migration_619 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemAbility = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserInventoryId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeakAgainstId = table.Column<int>(type: "INTEGER", nullable: false),
                    StrongAgainstId = table.Column<int>(type: "INTEGER", nullable: false),
                    SellPrice = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Feylings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Feylings_Abilities_AbilityId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Feylings_Types_StrongAgainstId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    FeylingId = table.Column<int>(type: "INTEGER", nullable: false),
                    UserInventoryId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feylings_AbilityId",
                table: "Feylings",
                column: "AbilityId");

            migrationBuilder.CreateIndex(
                name: "IX_Feylings_ItemId",
                table: "Feylings",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Feylings_StrongAgainstId",
                table: "Feylings",
                column: "StrongAgainstId");

            migrationBuilder.CreateIndex(
                name: "IX_Feylings_TypeId",
                table: "Feylings",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Feylings_WeakAgainstId",
                table: "Feylings",
